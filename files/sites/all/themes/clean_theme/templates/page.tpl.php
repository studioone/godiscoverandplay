...
<div id="wrap" class="clearfix">
  ...
  <div id="main" class="clearfix">
    ...
    <?php if (theme_get_setting('slideshow_display','clean_theme')): ?>
      <?php 
      /*$slide1_head = check_plain(theme_get_setting('slide1_head','clean_theme'));*/
	  $slide1_head = check_markup(theme_get_setting('slide1_head','clean_theme'), 'full_html'); 
	  $slide1_desc = check_markup(theme_get_setting('slide1_desc','clean_theme'), 'full_html'); 
      /*$slide2_head = check_plain(theme_get_setting('slide2_head','clean_theme'));*/
	  $slide2_head = check_markup(theme_get_setting('slide2_head','clean_theme'), 'full_html'); 
	  $slide2_desc = check_markup(theme_get_setting('slide2_desc','clean_theme'), 'full_html'); 
      /*$slide3_head = check_plain(theme_get_setting('slide3_head','clean_theme'));*/
	  $slide3_head = check_markup(theme_get_setting('slide3_head','clean_theme'), 'full_html');
	  $slide3_desc = check_markup(theme_get_setting('slide3_desc','clean_theme'), 'full_html'); 
   ...
   <div id="slider-wrap">
    ...
    <section id="post-content" role="main">
	  ...
	  <!-- uncomment to shoe theme default page title -->
  ...
  <div id="copyright" class="clearfix">
    <div class="one-half">
        <?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?> Studio One <?php //print $site_name; ?> | <a href="http://godiscoverandplay.com/about">About</a> - <a href="http://godiscoverandplay.com/terms-use">Terms of Use</a> - <a href="http://godiscoverandplay.com/privacy-policy">Privacy</a>
    </div>
    <div class="one-half column-last" id="credit">
	   ...
	   <a href="http://studioone.com/" target="_blank"><img src="http://godiscoverandplay.com/sites/all/themes/clean_theme/images/logo_son.png"/></a>
    </div>
  </div>
</div>
