...
<div id="wrapper">
  <header id="header" class="clearfix">
	...
	<?php if ($page['sponsor_unit']): ?>
  <div class="social-profile">
    <?php print render($page['sponsor_unit']); ?>
  </div> <!-- /sponsor unit -->
<?php endif; ?>
  ...
  <footer id="footer-bottom">
    ...
    <div id="bottom" class="clearfix">
      <div class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?> Studio One <?php //print $site_name; ?> | <a href="http://godiscoverandplay.com/about">About</a> - <a href="http://godiscoverandplay.com/terms-use">Terms of Use</a> - <a href="http://godiscoverandplay.com/privacy-policy">Privacy</a></div>
      <div class="credit"><a href="http://studioone.com/" target="_blank"><img src="http://godiscoverandplay.com/sites/all/themes/clean_theme/images/logo_son.png"/></a></div>
    </div>
  </footer>
